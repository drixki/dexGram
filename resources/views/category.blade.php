    ...
    <div class="card bg-light-info shadow-none position-relative overflow-hidden">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">Kategori Saya</h4>
                    <p class="mb-8">Halaman yang berisi kategori yang sudah anda buat.</p>
                    <a href="{{ route('create-category') }}" class="btn btn-primary">Tambah
                        Kategori</a>
                </div>
                <div class="col-3">
                    ...
                    <div class="position-relative">
                        ...
                        <div class="overlay d-flex flex-column">
                            ...
                            <div class="overlay-icons">
                                <a href="{{ route('update-category', encrypt($item->id)) }}"><i class="ti ti-edit"></i></a>
                                <a class="delete-btn cursor-pointer" data-url="{{ route('category-delete', $item->id) }}"><i
